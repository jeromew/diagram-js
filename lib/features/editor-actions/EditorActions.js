 ...
 *
 */
function EditorActions(eventBus, commandStack, modeling, selection, zoomScroll, clipboard, canvas, rules) {
  ...
  this._actions = {
    ...
    copy: function() {
      ...
      if (selectedElements) {
        eventBus.fire('elements.copy', { context: { elements: selectedElements } });
      }
    },
    paste: function() {
      clipboard.paste();
